...
namespace LeagueSharp.Common
{
    ...
    internal class Hacks
    {
        ...
        internal static void Initialize()
        {
            ...
            MenuDisableSay = menu.AddItem(new MenuItem("SayHack", "禁用 L# 發送聊天").SetValue(false).SetTooltip("遊戲中的聊天"));
            MenuDisableSay.ValueChanged += (sender, args) => EloBuddy.Hacks.IngameChat = args.GetNewValue<bool>();

            MenuTowerRange = menu.AddItem(new MenuItem("TowerHack", "顯示塔範圍").SetValue(true));
